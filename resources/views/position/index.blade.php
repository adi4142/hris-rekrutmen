        ...
        <div class="card shadow-sm border-0">
            <div class="card-header bg-white py-3">
                <div class="row align-items-center">
                    <div class="col-md-6">
                        <h3 class="card-title font-weight-bold m-0"><i class="fas fa-user-tag mr-2 text-primary"></i> Jabatan</h3>
                    </div>
                        ...
                        <form action="{{ route('position.index') }}" method="GET">
                            <div class="input-group input-group-sm" style="width: 220px;">
                                ...
                                <div class="input-group-append">
                                    @if(request('search'))
                                    <a href="{{ route('position.index') }}" class="btn btn-danger"><i class="fas fa-times"></i></a>
                                    @endif
